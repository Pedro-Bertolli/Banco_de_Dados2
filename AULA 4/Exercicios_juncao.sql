...
SELECT nome_barco AS "Nome do Barco", data_res AS "Data da Reserva" FROM barcos B
...
SELECT nome_marin AS "Nome Marinheiro", COUNT(data_res) AS "Quantidade" FROM marinheiros M
	INNER JOIN reservas R
	ON M.id_marin = R.id_marin
	GROUP BY nome_marin
	ORDER BY nome_marin;
